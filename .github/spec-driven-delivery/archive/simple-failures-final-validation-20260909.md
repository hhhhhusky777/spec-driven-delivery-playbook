...
| `D03`–`D06` | Canonical testing policy, workflow skill, contributing guide, and README diagrams | Focused review-loop and implementation-time regressions plus documentation gates |
