...
| Review owner | `<human or independent agent>` |
...
explicit transition to `APPROVED` can trigger the workflow. The author or
...
review agent; use a human reviewer whenever project policy, risk, or external
accountability requires one.
